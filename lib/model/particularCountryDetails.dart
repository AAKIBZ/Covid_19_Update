...
//
//     final particularCountryModel = particularCountryModelFromJson(jsonString);

import 'dart:convert';

ParticularCountryModel particularCountryModelFromJson(String str) => ParticularCountryModel.fromJson(json.decode(str));

String particularCountryModelToJson(ParticularCountryModel data) => json.encode(data.toJson());

class ParticularCountryModel {
  ParticularCountryModel({
    this.confirmed,
    this.recovered,
    this.deaths,
    this.lastUpdate,
  ...
  factory ParticularCountryModel.fromJson(Map<String, dynamic> json) => ParticularCountryModel(
